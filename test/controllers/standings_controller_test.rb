...
class StandingsControllerTest < ActionController::TestCase
  ...
  test "should create standing" do
    assert_difference('Standing.count') do
      post :create, standing: { losses: @standing.losses, percentage: @standing.percentage, team: @standing.team, week: @standing.week, wins: @standing.wins, year: @standing.year }
    end
  ...
  test "should update standing" do
    patch :update, id: @standing, standing: { losses: @standing.losses, percentage: @standing.percentage, team: @standing.team, week: @standing.week, wins: @standing.wins, year: @standing.year }
    assert_redirected_to standing_path(assigns(:standing))
  end
